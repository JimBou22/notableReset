					...
					<div class="col-sm-6">
						<div class="preview-pic tab-content product">
							<div class="tab-pane active" id="pic-1">
								<img src="images/black-calc.jfif" />
							</div>
						</div>
					</div>
					<div class="details col-sm-6 product-details">
						<h3 class="product-title">Calculator</h3>
						<div class="rating">
							<div class="stars">
						...
						<p class="product-description">Fast calculations as well as
							gaming. The one-in-all rig!</p>
						<h4 class="price">
							Price: <span>$12.99</span>
						</h4>
						<p class="vote">
							<strong>98%</strong> of buyers enjoyed this product! <strong>(84
								votes)</strong>
						</p>
						<p>
