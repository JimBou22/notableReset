        ...
        <div class="wrapper row">
          <div class="col-sm-6">
            <div class="preview-pic tab-content product">
              <div class="tab-pane active" id="pic-1"><img src="images/romphim.jpg" /></div>
            </div>
          </div>
          <div class="details col-sm-6 product-details">
            <h3 class="product-title">Stylish Romphim</h3>
            <div class="rating">
              <div class="stars">
            ...
            <p class="product-description">50% shirt, 50% pant, 100% stylish!</p>
