        ...
        <div class="wrapper row">
          <div class="col-sm-6">
            <div class="preview-pic tab-content product">
              <div class="tab-pane active" id="pic-1"><img src="images/tofu.jpg" /></div>
            </div>
          </div>
          <div class="details col-sm-6 product-details">
            <h3 class="product-title">Free-range Tofu</h3>
            <div class="rating">
              <div class="stars">
            ...
            <p class="product-description">100% grass-fed tofu!</p>
            <h4 class="price">Price: <span>$6.99</span></h4>
