        ...
        <div class="wrapper row">
          <div class="col-sm-6">
            <div class="preview-pic tab-content product">
              <div class="tab-pane active" id="pic-1"><img src="images/displayport-cable.jfif" /></div>
            </div>
          </div>
          <div class="details col-sm-6 product-details">
            <h3 class="product-title">HDMI Cable</h3>
            <div class="rating">
              <div class="stars">
            ...
            <p class="product-description">Cables not just for any console, but with rope functionality as well!</p>
